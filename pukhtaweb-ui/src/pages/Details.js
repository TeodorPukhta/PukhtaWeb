...
class Details extends Component {
    ...
    render() {
        ...
        return (
            ...
            <br></br><br></br>
           <div className="inputform"> <NavLink to ={"/comments/"+this.state.Book.idBook}>Comments</NavLink> | <NavLink to ={"/addComments/"+this.state.Book.idBook}>AddComment</NavLink></div>
